...
public final class AdUtil
{
  ...
  public static int a(Context paramContext, DisplayMetrics paramDisplayMetrics)
  {
    ...
    if (a < 4) {
      ...
      j = l.a(paramContext, paramDisplayMetrics);
    }
    return j;
  }
  ...
  public static int a(String paramString)
  {
    ...
    catch (NumberFormatException localNumberFormatException)
    {
      for (;;)
      {
        d.e("The Android SDK version couldn't be parsed to an int: " + Build.VERSION.SDK);
        d.e("Defaulting to Android SDK version 3.");
        int j = 3;
      }
    }
    return j;
  ...
  public static String a(Map paramMap)
  {
    ...
    catch (JSONException localJSONException)
    {
      for (;;)
      {
        d.d("JsonException in serialization: ", localJSONException);
      }
    }
    return str;
  }
  ...
  public static JSONArray a(Set paramSet)
  {
    ...
    for (localJSONArray = localJSONArray;; localJSONArray = localJSONArray)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (((localObject instanceof String)) || ((localObject instanceof Integer)) || ((localObject instanceof Double)) || ((localObject instanceof Long)) || ((localObject instanceof Float))) {
          ...
          {
            d.d("Unknown map type in json serialization: ", localClassCastException1);
          }
          ...
          {
            d.d("Unknown map type in json serialization: ", localClassCastException2);
          }
        } else {
          d.e("Unknown value in json serialization: " + localClassCastException2);
        }
      }
    }
  }
  ...
  public static boolean a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    {
      d.b("The android:configChanges value of the com.google.ads.AdActivity must include " + paramString + ".");
      bool = false;
    }
    return bool;
  }
  ...
  public static int b(Context paramContext, DisplayMetrics paramDisplayMetrics)
  {
    ...
    if (a < 4) {
      ...
      j = l.b(paramContext, paramDisplayMetrics);
    }
    return j;
  }
  ...
  public static HashMap b(Uri paramUri)
  {
    ...
    for (int m = 0;; m++)
    {
      ...
      int k = str.indexOf("=");
      if (k >= 0) {
        localHashMap.put(Uri.decode(str.substring(0, k)), Uri.decode(str.substring(k + 1, str.length())));
      } else {
    ...
    for (Object localObject1 = localJSONObject;; localObject1 = localJSONObject)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (((localObject2 instanceof String)) || ((localObject2 instanceof Integer)) || ((localObject2 instanceof Double)) || ((localObject2 instanceof Long)) || ((localObject2 instanceof Float))) {
          ...
          try
          {
            localJSONObject.put(str, a((Set)localClassCastException1));
          }
          catch (ClassCastException localClassCastException2)
          {
            d.d("Unknown map type in json serialization: ", localClassCastException2);
  ...
  public static boolean b(Context paramContext)
  {
    ...
    if (localPackageManager.checkPermission("android.permission.INTERNET", str) != -1)
    {
      if (localPackageManager.checkPermission("android.permission.ACCESS_NETWORK_STATE", str) != -1) {
        ...
        d.b("ACCESS_NETWORK_STATE permissions must be enabled in AndroidManifest.xml.");
      }
    }
    else {
      d.b("INTERNET permissions must be enabled in AndroidManifest.xml.");
    }
    return bool;
  }
  ...
  private static String c(String paramString)
  {
    try
    {
      ...
      localObject2 = ((Cipher)localObject2).doFinal(paramString.getBytes());
      byte[] arrayOfByte = new byte[localObject1.length + localObject2.length];
      ...
      localObject1 = g.b(arrayOfByte, 11);
  ...
  public static boolean c(Context paramContext)
  {
    ...
    if (b == null)
    {
      ...
      {
        d.b("Could not find com.google.ads.AdActivity, please make sure it is registered in AndroidManifest.xml.");
        b = Boolean.valueOf(false);
      }
      bool = b.booleanValue();
    }
  ...
  public static String i(Context paramContext)
  {
    if (i == null)
    {
      ...
      if ((str1 == null) || (str1.length() == 0) || (str1.equals("Java0")))
      {
        ...
        String str3 = ((Locale)localObject).getLanguage().toLowerCase(Locale.US);
        if (str3.length() == 0) {
          str3 = "en";
        }
        localObject = ((Locale)localObject).getCountry().toLowerCase(Locale.US);
        if (((String)localObject).length() > 0) {
          str3 = str3 + "-" + (String)localObject;
        }
        localObject = Build.MODEL + " Build/" + Build.ID;
        str1 = "Mozilla/5.0 (" + str1 + "; U; " + str2 + "; " + str3 + "; " + (String)localObject + ") AppleWebKit/0.0 (KHTML, like " + "Gecko) Version/0.0 Mobile Safari/0.0";
      }
